...
% numpats = 10; % Number of random patters
numpats = 20; % Number of random patters
% numpats = 200; % Number of random patters
...
%% Now, reproject this recovered image to get data to pass to the network
